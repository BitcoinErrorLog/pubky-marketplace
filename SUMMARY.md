...
**Final verification state (2026-08-22):** every claim above carries a same-day live proof against the deployed staging stack, recorded with reproduction commands in the [proof ledger](https://github.com/BitcoinErrorLog/pubky-app/blob/marketplace/pr25-ux/docs/ecommerce/status.md). One Ring approval now grants the whole app (public storage, encrypted messaging, private sync); sessions persist across tabs and restarts.
