...
| `/Users/johncarvalho/work/mp-oneauth` | Not a deploy tree. Branch `marketplace/one-approval` implements `docs/ecommerce/single-approval.md` (design merged `41aed56a`; **not shipped**) |
...
| Single-approval sign-in | **Design only.** `docs/ecommerce/single-approval.md` merged `41aed56a` after two Kimi rounds. Implementation is on `marketplace/one-approval` (`/Users/johncarvalho/work/mp-oneauth`), not on the deployed line. Do not describe as shipped. | `mp-ux` / `mp-oneauth` |
